...
<template>
  ...
  >
    <div class="w-full relative md:w-1/2">
      <div class="absolute w-full h-full select-none">
        <div class="absolute inset-0 bg-surface-950/70" />
        <NuxtImg
      ...
      <div
        class="w-full h-full flex flex-col justify-center p-4 md:p-20 items-center"
